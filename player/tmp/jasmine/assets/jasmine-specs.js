...
describe('player', function() {
  ...
  beforeEach(function(){
	happy_player = new PlayerWidget('happy');
	sad_player = new PlayerWidget('sad');
	angry_player = new PlayerWidget('angry');
  })
  ...
  describe('sourceSelector', function(){
  	...
  	it('selects the id of angry', function(){
  	  expect(angry_player.sourceSelector).toBe('angry')
  	})
  })
});
